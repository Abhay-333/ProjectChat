...
const PersonalInfo = () => {
  return (
    <div className="w-full h-[100vh] p-20 flex items-center bg-zinc-900">
      {/* Left Sidebar 
        ...
        <div className="flex flex-col items-center">
          ...
          {/* <div className="w-full space-y-4">
            ...
            <button
              ...
              className="w-full py-4 px-6 text-left rounded-lg bg-[red] text-white font-medium shadow-md"
            >
              Employee Management
            </button>
